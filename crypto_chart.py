...
headers = ["Name", "Rank", "Current Price", "Price Paid", "P/L Per Coin", "1 Hour Change", "24 Hour Change", "7 day Change", "Current Value", "P/L Total"]
...
coin_names = ["bitcoin", "ethereum", "xtrabytes", "ripple", "tron", "dash"]
    ...
    my_portfolio = [
        {
            "sym": "BTC",
            "amount_owned": 0.01,
            "price_paid_per": 4000.0
        },
        {
            "sym": "ETH",
            "amount_owned": 0.8,
            "price_paid_per": 500.0
        },
        {
            "sym": "XBY",
            "amount_owned": 1932,
...
def finish(row_count, portfolio_profit_loss, total_current_value):
    ...
    root.title("Cryoto Currency Porfolio - Portolio Value: ${0:.2f}".format(float(total_current_value)))
...
# 'pie' is not defined in the line above??
